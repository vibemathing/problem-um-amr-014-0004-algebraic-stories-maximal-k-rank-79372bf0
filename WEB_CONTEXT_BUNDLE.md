...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-014-0004-algebraic-stories-maximal-k-rank-79372bf0",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-014-0004-fd5285d3d59a",
        "url": "https://www.unsolvedmath.com/problems/AMR-014-0004"
      }
    ],
    "statement": {
      "language": "en",
      "text": "For any positive integers $k,d$, the maximal $k$-rank $\\operatorname{rk}^{\\max}_k(kd,2)$ of binary forms equals $k$. Additionally, in the above notation, binary forms representable by $\\ell_1 \\ell_2^{kd-1}$, where $\\ell_1$ and $\\ell_2$ are non-proportional linear forms, have the latter maximal $k$-rank.",
      "version": 1
    },
    "title": "Algebraic Stories — Maximal $k$-rank",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "01447b948ae2bcdc7876e1fbacca482c75f6fb06f2486ac3e092d633a19a501b"
}
```
